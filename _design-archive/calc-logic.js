...
function computeSeverance({ avgMonthlyMan = 350, yearsServed = 5, monthsServed = 0 }) {
...
function computeMortgage({ housePriceMan = 50000, annualIncomeMan = 6000, ltv = 70, dsr = 40, rate = 4.5, years = 30 }) {
...
function computeIncomeTax({ businessIncomeMan = 3000, employmentIncomeMan = 0, deductionsMan = 300 }) {
...
// 4) 실업급여
function computeUnemployment({ avgDailyWageMan = 12, ageGroup = '50미만', insuredYears = 3 }) {
