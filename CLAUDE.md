...
### 2026-05-16 2차 강화 검증 (추가 케이스 + 음주 정정)
| 케이스 | 우리 | 시장 | 결과 |
|---|---|---|---|
| 연봉 4000 부양1 식대20 | 294.3만 | 289~293만 | 0.4% |
| 연봉 6000 부양3 자녀1 | 429.1만 | 합리적 | PASS |
| 양도세 다주택 5억→10억 10년 LTCD20% | 1.39억 | 수식 일치 | PASS |
| 종소세 사업 5000만 | 661.6만 | 누진 정확 | PASS |
| 단위변환 1평 | 3.3057851m² | 3.3058m² | 100% |
| 환율 100JPY | 920원 (2026 평균) | 925원 (실시간) | 0.5% (참고) |
| 음주운전 과태료 | 150만→**500만** 정정 | 형사처벌 별도 안내 | 수정 |

**미정정 알려진 한계**:
- 양도세 다주택 중과 유예 종료 (2026-05-09 이후): +20%p/+30%p 추가 적용 필요 → 향후 케이스 분리
- 환율: 정적 평균값. 실시간 갱신 안 됨 (참고용 표시 명확)
- 중고차 시세: 단순 감가 모델. 차종·옵션 미반영 (참고용 명시)

### 2026-05-16 3차 정밀 검증 (구체 숫자 케이스)
| 케이스 | 우리 | 시장 | 결과 |
|---|---|---|---|
| 퇴직금 월 500만 10년 (90→91일 수정 후) | 4,945만 | 4,891만 | **1.1%** (이전 2.2%에서 개선) |
| 신용대출 3000만 5년 6.5% PMT | 월 586,984원 | 엑셀 PMT 586,955원 | **0.005%** (29원) |
| 복리 월 100만 20년 8% | 5.89억 | 5.49~6.5억 (가정 따라) | 범위 안 |
| 1근 → g | 600 | 600 | **0%** |
| 1냥 → g | 37.5 | 37.5 | **0%** |
| 1돈 → g | 3.75 | 3.75 | **0%** |
| 5L → 미국갤런 | 1.32086 | 1.32 | **0%** |

**정정 누적**:
- 퇴직금 평균임금 일수: 90일 → 91일 (실제 3개월 평균)

**총 누적 검증 케이스 수**: 50건+
**총 정정 항목**: 10건 (실업급여 상한, 국민연금 공식, 기초연금, 건강보험 요율, 식대 옵션, 기초생활 중위, 최저시급, 음주 과태료, 퇴직금 일수, 4대보험 자동연동)
