...
export const CALCULATORS: CalcMeta[] = [
  ...
  // 자동차
  { slug: '자동차세', name: '자동차세', desc: '배기량별 연 세액', time: '15초', catSlug: '자동차', catName: '자동차', works: true },
  { slug: '자동차-취득세', name: '자동차 취득세', desc: '신차·중고차', time: '20초', catSlug: '자동차', catName: '자동차', works: true },
  { slug: '유류비', name: '유류비', desc: '주행거리·연비 환산', time: '15초', catSlug: '자동차', catName: '자동차', works: true },
  { slug: '과태료', name: '과태료', desc: '위반 항목별 금액', time: '10초', catSlug: '자동차', catName: '자동차', works: true },
  { slug: '중고차-시세', name: '중고차 시세', desc: '연식·주행거리', time: '30초', catSlug: '자동차', catName: '자동차', works: true },
  // 일상
  { slug: '단위변환', name: '단위 변환', desc: '길이·무게·온도·면적', time: '5초', catSlug: '일상', catName: '일상', works: true },
  { slug: '환율', name: '환율', desc: '주요국 통화 환산', time: '5초', catSlug: '일상', catName: '일상', works: true },
